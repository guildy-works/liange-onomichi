            ...
            <div className="w-full max-w-screen-md mx-auto pt-12">
                ...
                <div className="grid md:grid-cols-2 py-12 mx-auto gap-2">
                    <div className="flex flex-col gap-4 sm:gap-8 p-8">
                        ...
                        <SkewScrollTriggerAnimation delay={100} tag="p" skewPanelClass="!bg-color2">
                            1997年TBCに入社。<br />
                        ...
                        <SkewScrollTriggerAnimation delay={400} tag="p" skewPanelClass="!bg-color2">
                        ...
                        <SkewScrollTriggerAnimation delay={700} tag="p" skewPanelClass="!bg-color2">
                            1967年9月19日生まれ<br />
                            O型<br />
                            乙女座
                        </SkewScrollTriggerAnimation>

                        <SkewScrollTriggerAnimation delay={800} tag="p" skewPanelClass="!bg-color2">
                    ...
                    <div className="px-8 my-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 gap-4 sm:gap-8">
                        <TransitionImage alt="プロフィール" src={img3} className="rounded-lg" />

                        <TransitionImage alt="受賞歴" src={img1} className="rounded-lg" />
                    </div>
                </div>
            </div>
        </div>
